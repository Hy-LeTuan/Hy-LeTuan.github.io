...
function Footer() {
	return (
		<footer className="overflow-hidden clear-both w-full bg-primary text-white mt-7 md:mt-8 lg:mt-9 xl:mt-10">
			<div className="flex justify-between items-top py-1 px-6 lg:px-9 lg:py-2">
