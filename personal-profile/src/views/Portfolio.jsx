...
function Portfolio() {
    ...
    // set font size for screen size changes
    ...
    useEffect(() => {
        // set initial font size and padding size 
        onScreenSizeChange();

        // check intial double column
        checkScreenSize();
        ...
        <>
            ...
            <section className="section-container bg-primary">
                <div className="w-full m-0 p-0 xl:w-3/4 xl:mx-auto">
                    ...
                    <div className="my-20 border-t-[0.5px] border-white lg:my-24 xl:my-28"></div>
                    <div className="title-subtitle-cluster">
